        ...
        chck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(((CheckBox)v).isChecked()){
                    Toast.makeText(Grapes.this, "Notifications will be shown periodically hereafter for the cultivation of Grapes", Toast.LENGTH_SHORT).show();
                    NotificationCompat.BigPictureStyle big=new NotificationCompat.BigPictureStyle();
                    big.bigPicture(BitmapFactory.decodeResource(getResources(),R.drawable.grapes)).build();
                    NotificationManager notificationManager=(NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
                    Intent resultIntent=new Intent(getApplicationContext(),Grapes.class);
                    ...
                    NotificationCompat.Builder builder=(NotificationCompat.Builder)new NotificationCompat.Builder(getApplicationContext())
                            ...
                            .setContentTitle("Check the grapes activity")
        ...
        if (contact != null) {
            contact.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    if(ActivityCompat.checkSelfPermission(Grapes.this, Manifest.permission.CALL_PHONE)!= PackageManager.PERMISSION_GRANTED) {
                        return;
                    }
                    startActivity(i);
                }
