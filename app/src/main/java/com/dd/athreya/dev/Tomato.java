        ...
        chck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(((CheckBox)v).isChecked()){
                    Toast.makeText(Tomato.this, "Notifications will be shown periodically hereafter for the cultivation of Tomato", Toast.LENGTH_SHORT).show();
                    NotificationCompat.BigPictureStyle big=new NotificationCompat.BigPictureStyle();
                    big.bigPicture(BitmapFactory.decodeResource(getResources(),R.drawable.tomato)).build();
                    ...
                    NotificationCompat.Builder builder=(NotificationCompat.Builder)new NotificationCompat.Builder(getApplicationContext())
                            ...
                            .setContentTitle("Check the tomato activity")
        ...
        if (contact != null) {
            contact.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    if(ActivityCompat.checkSelfPermission(Tomato.this, Manifest.permission.CALL_PHONE)!= PackageManager.PERMISSION_GRANTED) {
                        return;
                    }
                    startActivity(i);
                }
