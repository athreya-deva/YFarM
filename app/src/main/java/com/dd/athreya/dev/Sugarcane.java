        ...
        chck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(((CheckBox)v).isChecked()){
                    Toast.makeText(Sugarcane.this, "Notifications will be shown periodically hereafter for the cultivation of Sugarcane", Toast.LENGTH_SHORT).show();
                    NotificationCompat.BigPictureStyle big=new NotificationCompat.BigPictureStyle();
                    big.bigPicture(BitmapFactory.decodeResource(getResources(),R.drawable.sugarcane)).build();
                    NotificationManager notificationManager=(NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
                    Intent resultIntent=new Intent(getApplicationContext(),Sugarcane.class);
                    ...
                    NotificationCompat.Builder builder=(NotificationCompat.Builder)new NotificationCompat.Builder(getApplicationContext())
                            ...
                            .setContentTitle("Check the sugarcane activity")
        ...
        if (contact != null) {
            contact.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    if(ActivityCompat.checkSelfPermission(Sugarcane.this, Manifest.permission.CALL_PHONE)!= PackageManager.PERMISSION_GRANTED) {
                        return;
                    }
                    startActivity(i);
                }
